...
def run():
    ...
    extract_frames_and_remove_backgrounds(input_video_path, original_frame_dir, output_video_path, transparent_frame_dir)
    # TODO: Refactor to do the following:
    #       1) Read the input/output paths from a config
    #       2) Allow to optionally write both transparent and non-transparent versions instead of just transparent.
    #       3) Combine the frames into a result .mp4
